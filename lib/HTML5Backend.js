...
var HTML5Backend = function () {
  ...
  HTML5Backend.prototype.checkIfCurrentDragSourceRectChanged = function checkIfCurrentDragSourceRectChanged() {
    ...
    this.currentDragSourceNodeOffsetChanged = !shallowEqual(getNodeClientOffset(node), this.currentDragSourceNodeOffset);
  ...
  HTML5Backend.prototype.handleTopDragStart = function handleTopDragStart(e) {
    ...
    if (this.monitor.isDragging()) {
      if (typeof dataTransfer.setDragImage === 'function') {
        ...
        var anchorX = _getCurrentSourcePrev.anchorX;
        var anchorY = _getCurrentSourcePrev.anchorY;

        var anchorPoint = { anchorX: anchorX, anchorY: anchorY };
        var dragPreviewOffset = getDragPreviewOffset(sourceNode, dragPreview, clientOffset, anchorPoint);
      ...
      var captureDraggingState = _getCurrentSourcePrev2.captureDraggingState;
